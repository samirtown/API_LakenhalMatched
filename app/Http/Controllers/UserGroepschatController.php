...
class UserGroepschatController extends Controller
{
    ...
    public function usersInGroepActiviteit($user_ID){
        return UserGroepschat::where('user_ID','=',$user_ID)->join('groepschat', 'user_groepschat.groepschat_ID', '=', 'groepschat.groepschat_ID')
        ->join('activiteit', 'groepschat.groepschat_ID', '=', 'activiteit.activiteit_ID')->get();
    }
}
